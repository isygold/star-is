...
import com.starwinmod.winlator.ui.LocalTopBarActions
...
import com.starwinmod.winlator.box64.Box64PresetManager
...
import com.starwinmod.winlator.ui.theme.Divider as DividerColor
import com.starwinmod.winlator.ui.theme.OnSurface
import com.starwinmod.winlator.ui.theme.OnSurfaceVariant
import com.starwinmod.winlator.ui.theme.Primary
import com.starwinmod.winlator.ui.theme.Secondary
import com.starwinmod.winlator.ui.theme.Surface as SurfaceColor
import com.starwinmod.winlator.widget.CPUListView
import com.starwinmod.winlator.widget.EnvVarsView
                ...
                modifier = Modifier
                    ...
                    .background(
                        Brush.linearGradient(
                            colors = listOf(
                                com.starwinmod.winlator.ui.theme.Primary,
                                com.starwinmod.winlator.ui.theme.Secondary,
                            )
                        ),
...
private fun ShortcutSettingsDialogScreen(shortcut: Shortcut, onDismiss: () -> Unit) {
    ...
    if (showBox64DownloadSheet) {
        ContentDownloadSheet(
            contentType = com.starwinmod.winlator.contents.ContentProfile.ContentType.CONTENT_TYPE_BOX64,
    ...
    if (showFexCoreDownloadSheet) {
        ContentDownloadSheet(
            contentType = com.starwinmod.winlator.contents.ContentProfile.ContentType.CONTENT_TYPE_FEXCORE,
    ...
    if (showDxvkDownloadSheet) {
        ContentDownloadSheet(
            contentType = com.starwinmod.winlator.contents.ContentProfile.ContentType.CONTENT_TYPE_DXVK,
        ...
        AndroidView(
            factory = { ctx ->
                EnvVarsView(ctx).also { ev ->
                    ev.setDarkMode(true)
                    ev.setEnvVars(com.starwinmod.winlator.core.EnvVars(shortcut.getExtra("envVars")))
    ...
    try {
        ...
        if (sm != null && sm.isRequestPinShortcutSupported) {
            ...
            val bmp: Bitmap = shortcut.icon
                ?: BitmapFactory.decodeResource(context.resources, com.starwinmod.winlator.R.drawable.icon_wine)
