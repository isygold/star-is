...
import com.starwinmod.winlator.core.PreloaderState
...
import com.starwinmod.winlator.xserver.XKeycode
...
class ContainerDetailViewModel(app: Application) : AndroidViewModel(app) {
    ...
    private fun loadWinComponents(wincomponents: String) {
        winComponents.clear()
        val res = context.resources
        for (parts in com.starwinmod.winlator.core.KeyValueSet(wincomponents)) {
            val key   = parts[0]
